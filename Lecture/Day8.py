# -*- coding: utf-8 -*-
"""
Created on Wed May 15 11:01:21 2019
...
col_data = OrderedDict(zip(col_name,[A,B,C,D,E,F]))
df = pd.DataFrame(col_data)
df.to_csv("data/E:/Forsk ML/Coding Challenge/Day_8/former.csv")
...
browser = webdriver.Firefox(executable_path='C:/Users/computer/Downloads/geckodriver-v0.24.0-win32(1)/geckodriver.exe')
browser.get(url)
